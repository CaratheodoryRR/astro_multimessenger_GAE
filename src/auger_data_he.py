...
ebins_ = np.array([18.702, 18.801, 18.8996, 18.9986, 19.0996, 19.2006, 19.3002, 19.3997, 19.5002, 19.6011, 19.7001, 19.7983, 19.8976, 19.9979, 20.0993, 20.1998, 20.2986, 20.3973])

ecens_ = np.array([18.7515 , 18.8503 , 18.9491 , 19.0491 , 19.1501 , 19.2504 , 19.34995, 19.44995, 19.55065, 19.6506 , 19.7492 , 19.84795, 19.94775, 20.0486 , 20.14955, 20.2492 , 20.34795])
...
# Added by Christian
# ==================
dE = 10**ebins_[1:] - 10**ebins_[:-1]  # bin energy widths


Jauger = auger_ / dE # Energy flux
Jauger_scaled = Jauger / Jauger[0] # The first bin is always 1

Jauger_err = sigma_auger_ / dE # Flux error
